--
--Create_Proc_to_usp_ReOrganise_Rebuild_Indexes
--Only Reorganise indexes, between 10% to 40% fragmentation
--
--
Use DBAdmin
GO
IF OBJECT_ID('usp_ReOrganise_Rebuild_Indexes','P') IS NOT NULL
    DROP PROC usp_ReOrganise_Rebuild_Indexes
GO

Create PROCEDURE [usp_ReOrganise_Rebuild_Indexes] 
AS
Begin		
...
DECLARE database_cursor CURSOR FOR
   ...
   BEGIN
		...
		WHERE [Fragmentation%] > 10 AND [Fragmentation%] < 40			--Change this for Reorganize
		...
		Select * from #FragmentedIndexes  WHERE [Fragmentation%] > 10 AND [Fragmentation%] < 40 order by [Fragmentation%] desc		--Change this for Reorganize
